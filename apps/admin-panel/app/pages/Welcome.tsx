...
export default () => {
  ...
  const [editingRecord, setEditingRecord] = useState<DiaryEntryItem | null>(null)
  ...
  const handleSave = async (
    ...
    record: DiaryEntryItem,
    originRow: DiaryEntryItem,
    newLineConfig?: { index?: number; newData?: DiaryEntryItem } // 处理可选的 newLineConfig 参数
  ): Promise<void> => {
    try {
